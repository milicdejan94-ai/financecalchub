      ...
      <div className="container">
        ...
        <article className="content-box">
          ...
          <p>
            ...
            insurance, HOA fees and other homeownership costs. The loan amount
            is only the starting point. The full monthly cost can be
            meaningfully higher than principal and interest alone.
          </p>
          ...
          <p>
            A $300,000 mortgage payment can vary widely. A 30-year fixed loan at
            a lower interest rate may have a much smaller principal and interest
            ...
            <table className="data-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Total monthly cost rises even if the loan payment is
                    unchanged
                  </td>
                </tr>
              </tbody>
          ...
          <p>
            ...
            Later in the loan, more of the payment goes toward principal. This
            is why an{" "}
            <a href="/calculators/amortization">Amortization Calculator</a> can
            be helpful when you want to see how the balance declines month by
            month.
          </p>
            ...
            <table className="data-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    Can increase the monthly payment until it ends or changes
                  </td>
                </tr>
                <tr>
                  <td>HOA fees</td>
                  ...
                  <td>
                    Can be significant for condos, townhomes or planned
                    communities
                  </td>
                </tr>
                <tr>
          ...
          <p>
            Suppose a buyer has a $300,000 mortgage with a principal and
            interest payment of about $1,799 per month. If estimated property
            taxes are $350 per month, homeowners insurance is $125 per month and
            HOA fees are $100 per month, the estimated monthly housing cost
            becomes much higher than the loan payment alone.
          </p>
          ...
          <p>
            This example is not a quote or approval estimate. It simply shows
            why the full payment matters when comparing homes or deciding how
            much house may fit your budget.
          </p>

          <h2>How the down payment affects a $300,000 mortgage</h2>

          <p>
            The phrase “$300,000 mortgage” means the loan amount is $300,000.
            The home price may be higher if the buyer makes a down payment. For
            example, a $375,000 home with a $75,000 down payment could still
            result in a $300,000 mortgage before closing costs and other
            details.
          </p>

          <p>
            A larger down payment can reduce the loan amount, lower the monthly
            payment and sometimes reduce or eliminate mortgage insurance. Use
            the <a href="/calculators/down-payment">Down Payment Calculator</a>{" "}
          ...
          <p>
            ...
            usually lowers the monthly payment. A 15-year mortgage compresses
            the repayment schedule, which usually raises the monthly payment but
          ...
          <p>
            ...
            while others may not. For budgeting, it is safer to estimate the
            full housing cost, not just principal and interest.
          </p>

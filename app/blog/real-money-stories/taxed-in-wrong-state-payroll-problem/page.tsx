...
const story = {
  ...
  officialSources: [
    ...
    {
      title: "General Instructions for Forms W-2 and W-3",
...
export default function TaxedInWrongStatePayrollProblemPage() {
  return (
    <RealMoneyStoryTemplate story={story}>
      ...
      <p>
        Most employees think about payroll in terms of salary, hours worked and
        the amount deposited into their bank account.
      </p>

      <p>
        Payroll systems may also contain information related to work location,
        residence and state withholding.
      </p>

      <p>
        When one location setting is wrong or is not updated after a change, the
        same problem may repeat across multiple pay periods.
      </p>
      ...
      <p>
        The issue may only become obvious when the employee reviews a pay stub
        carefully or receives Form W-2.
      </p>

      <h2>The moment the numbers stopped making sense</h2>

      <p>
        A wrong-state payroll problem can be confusing because the employee may
        not believe they have any connection with the state shown in the payroll
        information.
      </p>
      ...
      <p>
        The answers can matter because state tax treatment depends on the facts
        and the rules of the states involved.
      </p>
      ...
      <p>Withholding is money taken from pay during the year.</p>

      <p>
        A tax return generally reconciles income, tax liability and tax payments
        or withholding under the applicable rules.
      </p>
      ...
      <p>
        Form W-2 contains federal wage and withholding information and may also
        contain state and local wage and tax information.
      </p>

      <p>
        The 2026 IRS instructions identify Boxes 15 through 20 as the area used
        for state and local income tax information.
      </p>
      ...
      <p>
        However, the IRS currently states that state or local information is not
        included with Form W-2 information on the wage and income transcript.
      </p>
      ...
      <p>
        This means an employee investigating a state payroll problem should not
        assume a federal wage transcript will show the entire state tax picture.
      </p>
      ...
      <p>
        ...
        correct errors on Forms W-2 or certain previously filed corrected forms
      ...
      <p>
        The Social Security Administration advises employers to file Forms W-2c
        and W-3c as soon as possible after discovering an error.
      </p>
      ...
      <p>But the key question remains:</p>
      ...
      <p>
        The employee needs to identify the specific state wage, withholding or
      ...
      <p>An outside payroll provider may also be part of the process.</p>
      ...
      <p>
        IRS guidance says an employee who believes a W-2 is incorrect should ask
        the employer to correct the error.
      </p>

      <p>
        If the employer does not correct the W-2 by the end of February, the IRS
        currently explains that the employee may call the IRS or make an
      ...
      <p>
        A multi-state issue may still require state-specific analysis even when
        federal W-2 procedures are relevant.
      </p>

      <h2>The wrong-state problem can be more complicated than a refund</h2>

      <p>An employee may initially think:</p>

      <p>
        <em>"The wrong state took money. I just need the money back."</em>
      </p>

      <p>But the situation may involve more than one question.</p>

      <p>Was tax withheld for the wrong state?</p>

      <p>Were wages reported to the wrong state?</p>

      <p>
        Does the employee need to file a return with that state to address the
        withholding?
      </p>

      <p>Does another state have a filing connection?</p>

      <p>Was the employee a part-year resident after moving?</p>

      <p>Did the employee live in one state and work in another?</p>

      <p>These are state-specific questions.</p>
      ...
      <p>Imagine an employee begins the year in State A.</p>
      ...
      <p>Months later, the employee sees two states on tax documents.</p>
      ...
      <p>
        Remote employees may live in one state while their employer or office is
        located in another.
      </p>

      <p>
        A payroll system may use employer records, work-location information or
        other data that the employee does not normally review.
      </p>
      ...
      <p>The goal is to identify a specific mismatch.</p>
      ...
      <p>identifies a more specific issue for review.</p>
      ...
      <p>
        And once a full year has passed, the problem may involve payroll, Forms
        W-2 or W-2c, multiple tax authorities and more than one return.
      </p>
      ...
      <p>Review state withholding after moving or changing work locations.</p>

      <p>Check state wage and withholding information on Form W-2.</p>

      <p>
        Keep records showing when and where you lived and worked when more than
        one state is involved.
      </p>

      <p>
        Ask payroll which work-location and withholding information appears in
        its system.
      </p>
      ...
      <p>
        For multi-state tax situations, review official guidance from the states
        involved or consider speaking with a qualified tax professional familiar
